...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Realismbtn_Click(object sender, EventArgs e)
        {
            ...
            int roundedValue = (int)Math.Round(weightedAverage, MidpointRounding.AwayFromZero);
            realism.Text = roundedValue.ToString();
        }
        ...
        private void EMVbtn_Click(object sender, EventArgs e)
        {
            ...
            int roundedValue = (int)Math.Round(EMV, MidpointRounding.AwayFromZero);
        ...
        private void EOLBtn_Click(object sender, EventArgs e)
        {
            ...
            int roundedValue = (int)Math.Round(EOL, MidpointRounding.AwayFromZero);
            Eol.Text=roundedValue.ToString();
